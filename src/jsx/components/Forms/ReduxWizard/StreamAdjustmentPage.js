  ...
  return (
		<form onSubmit={handleSubmit}>
			<div className="validate-redux-form row">
				...
				<div className="col-sm-8">
					<Field name="loanTenure" type="text" component={renderField} label="Loan Tenure"/>
				</div>	
				<div className="col-sm-4">
                ...
                <div className="col-sm-8">
					<Field name="flowRateTenure" type="text" component={renderField} label="Loan deduction frequency in days"/>
				</div>	
				<div className="col-sm-4">
