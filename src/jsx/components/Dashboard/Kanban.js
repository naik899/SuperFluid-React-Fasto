	...
	return(
		<Fragment>
			<div className="project-nav align-items-end">
				...
				<div className="mt-3">
					<Link to={"#"} onClick={ () => setNewProject(true)} className="btn btn-primary  rounded mr-3 mb-sm-0 mb-2 text-white"><i className="fa fa-user mr-3 scale5" aria-hidden="true"></i>New Contact</Link>
					{/* <!-- Add Order --> */}
