	...
	return(
		<>
			...
			<div className="d-flex">
				<p className="font-w500 mr-auto mb-2 title fs-20"><Link to={"./post-details"} className="text-black">{titleMenu}</Link></p>
				<DropdownBlog />
			</div>
			<div className="mb-3"><i className="fa fa-calendar-o mr-3" aria-hidden="true"></i>Created on Sep 8th, 2020</div>
			<div className="media align-items-center">
				<div className="power-ic mr-3">
					<i className="fa fa-bolt" aria-hidden="true"></i>
				</div>
				<div className="media-body">
					<p className="mb-1">Deadline</p>
					<span className="text-black font-w600">Tuesday,  Sep 29th 2020</span>
				</div>
			</div>
		</>
	)	
...
function Icon3(){
	return(
		<>
			<svg className="primary-icon" width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
			...
			<Dropdown className="mb-3">
				<Dropdown.Toggle variant="" as="div" className="i-false" >	
					<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M12 13C12.5523 13 13 12.5523 13 12C13 11.4477 12.5523 11 12 11C11.4477 11 11 11.4477 11 12C11 12.5523 11.4477 13 12 13Z" stroke="#575757" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
						<path d="M12 6C12.5523 6 13 5.55228 13 5C13 4.44772 12.5523 4 12 4C11.4477 4 11 4.44772 11 5C11 5.55228 11.4477 6 12 6Z" stroke="#575757" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
						<path d="M12 20C12.5523 20 13 19.5523 13 19C13 18.4477 12.5523 18 12 18C11.4477 18 11 18.4477 11 19C11 19.5523 11.4477 20 12 20Z" stroke="#575757" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
					</svg>
				</Dropdown.Toggle>	
...
export {titleBlog , DropdownBlog, ProjectBlog};
